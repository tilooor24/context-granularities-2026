"""Finding the buggy lines in Bears benchmark by comparing buggy and correct versions"""
...
from ..configs import bears_gen_dir, bears_root, bears_tmp_dir, tree_sitter_lib
...
def generate_data(bug_hunks: dict[str, list[DiffHunk]]) -> None:
    ...
    bears_gen_dir.mkdir(parents=True, exist_ok=True)
    with (
